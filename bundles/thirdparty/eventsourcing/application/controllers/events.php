...
use EventSourcing\Setting;
use EventSourcing\EventStore;

class EventSourcing_Events_Controller extends Controller {
	...
	public function get_index()
	{
		...
		return View::make('eventsourcing::events.index')->with('events', $events)->with('eventhandlers', $eventhandlers);
	}
